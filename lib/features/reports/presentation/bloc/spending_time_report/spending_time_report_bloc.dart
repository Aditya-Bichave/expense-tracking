...
class SpendingTimeReportBloc
  ...
  SpendingTimeReportBloc({
    ...
    add(const LoadSpendingTimeReport()); // Initial load with default granularity & no comparison
  }
  ...
  void _onFilterChanged(
    ...
    add(LoadSpendingTimeReport(
        granularity: currentGranularity, compareToPrevious: compare));
  }
  ...
  void _onChangeGranularity(
    ...
    final compare = state is SpendingTimeReportLoaded
        ...
        : false;
    add(LoadSpendingTimeReport(
        granularity: event.granularity, compareToPrevious: compare));
  }
  ...
  Future<void> _onLoadReport(LoadSpendingTimeReport event,
    ...
    emit(SpendingTimeReportLoading(
