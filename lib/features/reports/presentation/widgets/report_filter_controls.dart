  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ReportFilterBloc, ReportFilterState>(
      builder: (context, state) {
        ...
        // Problem: .where().map().toList() creates multiple intermediate iterables in the build method
        // Solution: Use a collection for to filter and map in a single pass
        // Impact: Reduces garbage collection pressure during UI rebuilds
        final categoryItems = [
