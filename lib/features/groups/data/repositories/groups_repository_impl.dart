...
class GroupsRepositoryImpl implements GroupsRepository {
  ...
  Future<Either<Failure, void>> refreshGroupsFromServer() async {
    try {
      ...
      // 💡 What: Replaced `.where().map().toList()` chain with list comprehension.
      // 🎯 Why: Chaining creates multiple intermediate iterables during sync.
      // 📊 Impact: Prevents O(N) allocations for temporary lists when finding stale IDs.
      final staleGroupIds = [
