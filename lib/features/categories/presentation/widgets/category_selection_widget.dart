...
enum CategoryTypeFilter { expense, income } // Enum to specify type
...
class _CategoryPickerDialogContentState
  ...
  // Use specific use cases injected via sl
                    ...
                    : _filteredCategories.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              // TODO: Replace placeholder Icon with actual icon rendering logic
                              ...
                              return ListTile(
                                ...
                                onTap: () {
                                  ...
                                  Navigator.of(context).pop(
                                      category); // Return selected category
                                },
                              );
                            },
                          ),
          ),
          // TODO: Add "+ Add New Category" Button -> Needs navigation setup
          // ElevatedButton.icon(onPressed: (){}, icon: Icon(Icons.add), label: Text("Add New Category"))
        ],
      ),
    );
  }
