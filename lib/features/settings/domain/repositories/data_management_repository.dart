...
class AllData {
  ...
  Map<String, dynamic> toJson() => {
    ...
    AppConstants.backupAccountsKey: [for (final a in accounts) a.toJson()],
    AppConstants.backupExpensesKey: [for (final e in expenses) e.toJson()],
    AppConstants.backupIncomesKey: [for (final i in incomes) i.toJson()],
