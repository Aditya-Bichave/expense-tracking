...
void main() {
  ...
  late MockSaveUserCategorizationHistoryUseCase mockSaveUserCategorizationHistoryUseCase;
  ...
  setUp(() {
    ...
    mockSaveUserCategorizationHistoryUseCase = MockSaveUserCategorizationHistoryUseCase();
    ...
    registerFallbackValue(ApplyCategoryToBatchParams(
      transactionIds: [],
      categoryId: 'cat1',
  ...
  group('TransactionListBloc', () {
    ...
    blocTest<TransactionListBloc, TransactionListState>(
      ...
      build: () {
        when(() => mockApplyCategoryToBatchUseCase(any()))
      ...
      expect: () => [
        ...
        isA<TransactionListState>()
            ...
            .having((s) => s.errorMessage, 'errorMessage', contains('Batch update failed')),
      ],
      verify: (_) {
    ...
    blocTest<TransactionListBloc, TransactionListState>(
      ...
      expect: () => [
        ...
        isA<TransactionListState>()
            .having((s) => s.status, 'status', ListStatus.reloading)
            .having((s) => s.deleteError, 'deleteError', contains('Delete failed')),
